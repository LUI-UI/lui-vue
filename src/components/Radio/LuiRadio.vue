...
export default {
  ...
  setup(props, { attrs }) {
    ...
    const isChecked = computed(() => {
      return props.checked || attrs?.modelValue === props.value;
    });
    ...
    const computedClasses = computed(() => {
      const classes = {
        ...
        span: {
          ...
          ringWidth:
            props.size === "sm" ? "peer-focus:ring-1" : "peer-focus:ring-2",
        ...
        spanStates: {
          border: "peer-disabled:border-secondary-300",
          background: "peer-disabled:before:bg-white",
        },
      };
      return {
        input: generateClasses([{ ...classes.input }]),
        span: generateClasses([
          { ...classes.span },
          { ...classes.spanBefore },
          { ...classes.spanStates },
        ]),
    ...
    return { computedClasses, isChecked };
  },
};
</script>
